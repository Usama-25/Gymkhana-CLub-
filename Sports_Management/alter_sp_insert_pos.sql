...
BEGIN
    ...
    IF @PaymentMode IS NULL
        SET @PaymentMode = 'Online Payment';
    ...
    -- If MemberID is provided, generate ledger entries
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUES (@MemberID, GETDATE(), @DescCharge, @FinalAmount, 0, 'POS', @NewTxnID, @DependentMemberNo, @DependentName, @DependentRelation);
        END
