...
BEGIN
    ...
    BEGIN
        ...
        -- Policy discount might have been calculated as 50% or 100% of the OLD base fee. 
        ...
        -- Let's stick to the dynamically calculated fee:
        ...
        -- If NetFee is not null, use calculated fee (in case GST changed), otherwise fallback to BaseFee
