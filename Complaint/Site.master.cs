...
public partial class SiteMaster : MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["EFName"] != null)
            efName = (Session["EFName"] != null ? Session["EFName"].ToString() : "");

        string userName = (Session["UserName"] != null ? Session["UserName"].ToString() : "Admin");

        string empIdText = " (" + empId.ToString() + ")";
    ...
    private string GetConnectionString()
    {
        return ConfigurationManager.ConnectionStrings["ComplaintsDB"] != null
            ...
            : (ConfigurationManager.ConnectionStrings["Users_ConnectionString"] != null
    ...
    private void BindDynamicNav()
    {
        ...
        if (Session["UserRole"] != null)
            role = (Session["UserRole"] != null ? Session["UserRole"].ToString() : "");
