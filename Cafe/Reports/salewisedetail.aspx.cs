...
public partial class Cafe_Reports_Coverwise : System.Web.UI.Page
{
...
//             e.DataSources.Add(new object("DataSetFooter", dt));
    ...
    private void ShowReport()
    {
        ...
        try
        {
            ...
            SqlParameter[] sqlParam = { new SqlParameter("@FromDate", txtStartDate.Text),
                                        new SqlParameter("@ToDate", txtEndDate.Text),
                                        //new SqlParameter("@item_code", hfItemCode.Value),
                                        //new SqlParameter("@SubdeptID", ddlSubDept.SelectedValue)
                                        };
            DataTable dt = new DataTable();
            dt = dbMgr.ExecuteDataTable("sp_GetOutletCoverSalesSummary", "RestaurantConnectionString", sqlParam);
...
//             ReportViewer1.LocalReport.DataSources.Add(object);
            //object rp = new object("StartDate", StartDate);
            //object rp1 = new object("Outlet", ddlSubDept.SelectedItem.Text);
            //object rp2 = new object("EndDate", EndDate);

            //ReportViewer1.LocalReport.SetParameters(new object[] { rp, rp1,rp2 });
