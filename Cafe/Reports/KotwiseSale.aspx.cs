...
public partial class KotwiseSale : System.Web.UI.Page
{
...
//                 e.DataSources.Add(new object("DataSetFooter", dt));
  ...
  {
    new SqlParameter("@FromDate", Convert.ToDateTime(txtStartDate.Text)),
    new SqlParameter("@ToDate", Convert.ToDateTime(txtEndDate.Text))
};

            DataTable dt = dbMgr.ExecuteDataTable(
                "sp_Kotwisesalereport",
