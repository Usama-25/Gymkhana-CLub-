...
public partial class ListingByItemSaleDetail : System.Web.UI.Page
{
            ...
            SqlParameter[] sqlParam =
{
    ...
    new SqlParameter("@SubDeptID", ddlSubDept.SelectedValue)
            ...
            DataTable dt = new DataTable();
            dt = dbMgr.ExecuteDataTable("sp_GetOutletChecksListingByItemSaleDetail", "RestaurantConnectionString", sqlParam);
...
//             object rp = new object("Start_Date", StartDate);
