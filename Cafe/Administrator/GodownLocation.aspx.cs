...
public partial class Store_GodownLocation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        gridGodownLocation.DataBind();
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO GodownLocation(Location_Name,Subdept_ID) Values(@Location_Name,@Subdept_ID)", con);
            cmd.Parameters.AddWithValue("@Location_Name", txtboxgodown.Text);
