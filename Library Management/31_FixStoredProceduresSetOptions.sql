...
-- 1. Re-compile sp_IssueBook with correct SET options
PRINT 'Re-compiling dbo.sp_IssueBook...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
-- 2. Re-compile sp_ReturnCollectReissue with correct SET options
PRINT 'Re-compiling dbo.sp_ReturnCollectReissue...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
-- 3. Re-compile sp_GetActiveReservations with correct SET options
PRINT 'Re-compiling dbo.sp_GetActiveReservations...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
-- 4. Re-compile sp_Report_BookIssuance with correct SET options
PRINT 'Re-compiling dbo.sp_Report_BookIssuance...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
-- 5. Re-compile sp_Report_IssuedNotReturned with correct SET options
PRINT 'Re-compiling dbo.sp_Report_IssuedNotReturned...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
-- 6. Re-compile sp_GetOverdueReminderList with correct SET options
PRINT 'Re-compiling dbo.sp_GetOverdueReminderList...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
-- 7. Re-compile sp_GetFinalChargedLoans with correct SET options
PRINT 'Re-compiling dbo.sp_GetFinalChargedLoans...';
GO
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
GO
...
PRINT '=== All stored procedures re-compiled successfully with correct options ===';
GO
