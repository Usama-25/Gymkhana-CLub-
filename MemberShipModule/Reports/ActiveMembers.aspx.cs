...
{
    public partial class ActiveMembers : Page
    {
        ...
        private void BindGrid()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("usp_GetActiveMembers", conn))
                {
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .status { font-weight: 600; color: #38a169; }
...
<body>
    <div class='header'>
        ...
        <div class='subtitle'>Active Members Report</div>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>");
            ...
            {
                html.Append("<tr><td colspan='6' class='no-data'>No active members found.</td></tr>");
            }
    ...
    <script>window.onload = function() { window.print(); }</script>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ActiveMembersReport.xls");
            Response.Charset = "";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                gvActiveMembers.AllowPaging = false;
                this.BindGrid();
                gvActiveMembers.RenderControl(hw);
