...
{
    public partial class AbsenteeMembers : Page
    {
        ...
        private void BindGrid()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("usp_GetAbsenteeMembersReport", conn))
                {
                    ...
                    gvAbsenteeMembers.DataSource = dt;
                    gvAbsenteeMembers.DataBind();
                }
            }
        }
...
<head>
    <meta charset='utf-8'>
    <title>Absentee Members Report</title>
    <style>
...
<body>
    <div class='header'>
        ...
        <div class='subtitle'>Absentee Members Report</div>
    </div>
    <table>
        <thead>
            <tr>
        ...
        <tbody>");
            ...
            {
                html.Append("<tr><td colspan='6' class='no-data'>No absentee members found.</td></tr>");
            }
    ...
    <script>window.onload = function() { window.print(); }</script>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AbsenteeMembersReport.xls");
            Response.Charset = "";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                gvAbsenteeMembers.AllowPaging = false;
                this.BindGrid();
                gvAbsenteeMembers.RenderControl(hw);
