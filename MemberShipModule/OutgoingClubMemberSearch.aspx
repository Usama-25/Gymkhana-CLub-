<%@ Page Title="Outgoing Club Member Search" Language="C#" MasterPageFile="~/MemberShipModule/Site.master"
    AutoEventWireup="true" CodeFile="OutgoingClubMemberSearch.aspx.cs" Inherits="OutgoingClubMemberSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="search-page">
        ...
        <div class="search-header">
            ...
            <div>
                <h1>Outgoing Club Member Search & Reporting</h1>
                <p>Advanced filtering and monthly, yearly, or clubwise visit reporting for local members</p>
            </div>
        </div>
                ...
                <div class="search-card">
                    ...
                    <div class="filters-grid">
                        <div class="filter-group">
                            ...
                            <asp:TextBox ID="txtIntroNo" runat="server" placeholder="e.g. OUT-LC-..." />
                        </div>
                        <div class="filter-group">
