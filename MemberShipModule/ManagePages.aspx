<%@ Page Title="Manage Pages" Language="C#" MasterPageFile="~/MemberShipModule/Site.master"
    AutoEventWireup="true" CodeFile="ManagePages.aspx.cs" Inherits="ManagePages" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <style>
            ...
            .filter-row:after { content: ""; display: table; clear: both; }
            .filter-row label { float: left; margin-right: 10px; padding-top: 6px; }
            .filter-row select { float: left; }
                ...
                <div class="mgmt-page">
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPageTitle" runat="server" placeholder="e.g. Member Profile" />
                            </div>
                            <div class="form-group">
                                <label>Page URL</label>
                                <asp:TextBox ID="txtPageUrl" runat="server" placeholder="~/WebForms/..." />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label>Icon Class</label>
                                <asp:TextBox ID="txtIconClass" runat="server" placeholder="fas fa-file" />
                            </div>
                            <div class="form-group">
                                <label>Order</label>
                    ...
                    <div class="form-card">
                        <div class="filter-row">
                            <label>Filter:</label>
                            <asp:DropDownList ID="ddlFilterModule" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlFilterModule_SelectedIndexChanged" />
                        </div>
                        <asp:GridView ID="gvPages" runat="server" AutoGenerateColumns="false" CssClass="grid-table"
                            DataKeyNames="PageId" OnRowCommand="gvPages_RowCommand" EmptyDataText="No pages found.">
                            <Columns>
                                <asp:BoundField DataField="PageId" HeaderText="ID" />
                                <asp:TemplateField HeaderText="Module">
                                    <ItemTemplate><span class="module-badge">
                                            <%# Eval("ModuleName") %>
                                        </span></ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditPage"
                                            CommandArgument='<%# Eval("PageId") %>' CssClass="btn-edit" Text="Edit" />
                                        <asp:LinkButton ID="btnDelete" runat="server" CommandName="DeletePage"
                                            CommandArgument='<%# Eval("PageId") %>' CssClass="btn-danger" Text="Delete"
                                            OnClientClick="return confirm('Delete this page?');" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
