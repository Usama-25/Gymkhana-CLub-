<%@ Page Title="LAHORE GYMKHANA" Language="C#" MasterPageFile="~/MemberShipModule/Site.master" AutoEventWireup="true"
    CodeFile="ApplicantSearch.aspx.cs" Inherits="Form_cell.Applicant_Form.ApplicantSearch" %>
        ...
        <div class="page-wrapper mt-6" style="margin-top: 0.75rem; /* Heavily reduced */;">
            <div class="card" style="background-color: #ffffff; border-radius: 12px; padding: 1.25rem; border: 1px solid #e2e8f0; box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05); transition: none; /* Removed hover effect */ position: relative; overflow: hidden; height: 100%; /* Slightly reduced padding */;">
                ...
                <div class="flex items-center justify-between mb-8 pb-6 border-b border-subtle" style="align-items: center; justify-content: space-between; margin-bottom: 2rem; margin-bottom: 2rem !important; padding-bottom: 1.5rem !important; border-bottom: 1px solid #e2e8f0; border-color: #e2e8f0 !important;">
                    <div>
                        <h1 class="text-2xl font-bold text-primary-900 m-0" style="font-size: 1.5rem !important; font-weight: 700; color: #0f172a !important; margin: 0;">Applicant Search</h1>
                        <p class="text-secondary mt-1" style="color: #475569 !important; margin-top: 0.25rem !important;">Find and manage applicant records</p>
                    </div>
                </div>
                    ...
                    <div class="form-section" style="padding: 1rem; margin-bottom: 1rem;">
                        <div class="section-header" style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem;">
                            ...
                            <div>
                                ...
                                <p class="section-subtitle" style="font-size: 0.875rem; color: #475569; margin: 0;">Enter details to locate application</p>
                            </div>
                        </div>
                        ...
                        <asp:Label ID="lblResult" runat="server" CssClass="status-message block mt-4 text-center" style="font-size: 0.875rem; color: #64748b; margin-top: 0.5rem; display: block; display: block !important; /* Heavily reduced */; text-align: center !important;">
                        </asp:Label>
                        <asp:Label ID="lblMessage" runat="server" CssClass="status-message block mt-2 text-center" style="font-size: 0.875rem; color: #64748b; margin-top: 0.5rem; display: block; display: block !important; margin-top: 0.5rem !important; text-align: center !important;">
                        </asp:Label>
                    </div>
                </div>
                ...
                <div class="form-section" style="padding: 1rem; margin-bottom: 1rem;">
                    <div class="section-header" style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem; padding-bottom: 0.75rem; border-bottom: 1px solid #e2e8f0; padding-bottom: 0.5rem;">
                        ...
                        <div>
                            ...
                            <p class="section-subtitle" style="font-size: 0.875rem; color: #475569; margin: 0;">Applicants matching your criteria</p>
                        </div>
                    </div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Visible="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <div class="flex gap-2 justify-center" style="gap: 0.5rem; justify-content: center; justify-content: center !important;">
                                            <asp:Button ID="btnRecive" runat="server" Visible="true" Text="Proceed"
                                                CommandName="Receive" CommandArgument='<%# Eval("Id") %>'
                                                OnClick="Recived_Click" CssClass="btn btn-secondary btn-sm" style="padding: 0.75rem 1.5rem; border-radius: 6px; font-weight: 600; font-size: 0.95rem; cursor: pointer; text-align: center; display: inline-block; line-height: 1; border: 1px solid #e2e8f0; background-color: white; color: #334155; box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05);" />

                                            <asp:Button ID="btnAdd" runat="server" Visible="false" Text="Receive Payment"
