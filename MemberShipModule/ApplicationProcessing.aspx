<%@ page title="Application Tracking" language="C#" masterpagefile="~/MemberShipModule/Site.master"
    autoeventwireup="true" codefile="ApplicationProcessing.aspx.cs" inherits="ApplicationProcessing" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <div class="page-wrapper mt-6" style="margin-top: 0.75rem; /* Heavily reduced */;">
            <div class="card"
                style="background-color: #ffffff; border-radius: 12px; padding: 1.25rem; border: 1px solid #e0d5c5; box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05); transition: none; /* Removed hover effect */ position: relative; overflow: hidden; height: 100%; /* Slightly reduced padding */;">
                    ...
                    <contenttemplate>
                        <asp:PlaceHolder ID="phFormContent" runat="server" Visible="false">
                                ...
                                <contenttemplate>
                                    ...
                                    <div id="divPersonal" class="form-section" style="padding: 1.5rem; background: #ffffff; border-radius: 1rem; border: 1px solid #e0d5c5; margin-bottom: 2rem;">
                                        ...
                                        <div style="display: flex; justify-content: center; gap: 1rem; margin-top: 2.5rem; padding-top: 1.5rem; border-top: 1px solid #F7F3EE;">
                                            ...
                                            <asp:Button ID="btnSavePersonal" runat="server" Text="Save"
                                                OnClick="btnSaveMembership_Click" Visible="false"
                                    ...
                                    <div id="divAddress" class="form-section" style="padding: 1.5rem; background: #ffffff; border-radius: 1rem; border: 1px solid #e0d5c5; margin-bottom: 2rem;">
                                        ...
                                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; margin-bottom: 2.5rem;">
                                            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                                                <label style="font-size: 0.875rem; font-weight: 600; color: #8B5E3C;">Phone</label>
                                                            ...
                                                            <asp:GridView ID="gvChildren" runat="server" AutoGenerateColumns="false" ShowHeader="true" OnRowCommand="gvChildren_RowCommand"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Relationship">
                                                                        <ItemTemplate>
                                                                            <asp:DropDownList ID="ddlChildRelation" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlChildRelation_SelectedIndexChanged"
                                                                                style="width: 100%; padding: 0.5rem; border: 1px solid #e0d5c5; border-radius: 0.375rem;">
                                                                            </asp:DropDownList>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="DOB">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtChildDOB" runat="server" placeholder="DD-MM-YYYY" Text='<%# Bind("DOB", "{0:dd-MM-yyyy}") %>' onchange="calculateChildAge(this)"
                                                                                style="width: 100%; padding: 0.5rem; border: 1px solid #e0d5c5; border-radius: 0.375rem;" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                            ...
                            <div id="divPayment" class="form-section"
                                ...
                                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid #F7F3EE;">
