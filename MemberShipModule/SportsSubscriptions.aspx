<%@ Page Title="Sports Subscriptions" Language="C#" MasterPageFile="~/MemberShipModule/Site.master" AutoEventWireup="true" CodeFile="SportsSubscriptions.aspx.cs" Inherits="MemberShipModule.SportsSubscriptions" %>
    ...
    <div class="page-wrapper mt-6" style="margin-top: 0.75rem;">
        <div class="card" style="background-color: #ffffff; border-radius: 12px; padding: 1.25rem; border: 1px solid #e0d5c5; box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05);">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px solid #e0d5c5;">
                <div>
                    <h1 style="font-size: 1.5rem; font-weight: 700; color: #fff; margin: 0;">Sports Subscriptions</h1>
                </div>
            ...
            <div style="background: #faf7f2; padding: 1rem; border-radius: 8px; border: 1px solid #e0d5c5; margin-bottom: 1.5rem;">
                ...
                <div class="grid-layout" style="grid-template-columns: 100px 200px 100px minmax(200px, 1fr); margin-top: 1rem;">
                    ...
                    <div>
                        <asp:DropDownList ID="ddlSports" runat="server" CssClass="form-control">
                            <asp:ListItem Value="BILLIARD">BILLIARD</asp:ListItem>
                            <asp:ListItem Value="CARD ROOM">CARD ROOM</asp:ListItem>
                            <asp:ListItem Value="CRICKET">CRICKET</asp:ListItem>
                            <asp:ListItem Value="GOLF" Selected="True">GOLF</asp:ListItem>
                            <asp:ListItem Value="GYMNASIUM">GYMNASIUM</asp:ListItem>
                            <asp:ListItem Value="Non Playing Fixed Contribution">Non Playing Fixed Contribution</asp:ListItem>
                            <asp:ListItem Value="SQUASH">SQUASH</asp:ListItem>
                            <asp:ListItem Value="SWIMMING POOL">SWIMMING POOL</asp:ListItem>
                    ...
                    <div>
                        <asp:DropDownList ID="ddlSubsType" runat="server" CssClass="form-control">
                            <asp:ListItem Value="GFB">GFB</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                <h3 style="font-size: 1rem; color: #1A1A2E; margin-bottom: 0.5rem;">Search Results</h3>
                <div class="table-container" style="overflow-x: auto;">
                    <asp:GridView ID="gvSearchResults" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table" GridLines="None"
                        OnSelectedIndexChanged="gvSearchResults_SelectedIndexChanged" DataKeyNames="MemberNo">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ChargeText" HeaderText="Charge" />
                            ...
                            <asp:BoundField DataField="LockerAmount" HeaderText="Locker Amount" />
            ...
            <div style="background: #faf7f2; padding: 1.5rem; border-radius: 8px; border: 1px solid #e0d5c5; margin-bottom: 1.5rem;">
                <div style="display: grid; grid-template-columns: 1fr 1.5fr 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
                    <div>
                    ...
                    <div>
                        <label style="font-size: 0.875rem; font-weight: 600; color: #1A1A2E;">Name:</label>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 2fr; gap: 1rem; margin-bottom: 1rem;">
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="ddlDetailChargeType" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>

                <div style="display: grid; grid-template-columns: 1fr 1fr 1.5fr auto; gap: 1rem; align-items: end; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #e0d5c5;">
                    <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr auto; gap: 1rem; align-items: end;">
                    <div>
                        <label style="font-size: 0.875rem; font-weight: 600; color: #1A1A2E;">Locker No:</label>
                        <asp:TextBox ID="txtLockerNo" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div>
                        <label style="font-size: 0.875rem; font-weight: 600; color: #1A1A2E;">Locker Amount:</label>
                        <asp:TextBox ID="txtLockerAmount" runat="server" CssClass="form-control" Text="0.00"></asp:TextBox>
                    </div>
                    <div>
                        <label style="font-size: 0.875rem; font-weight: 600; color: #1A1A2E;">Charge:</label>
                        <asp:DropDownList ID="ddlLockerCharge" runat="server" CssClass="form-control">
                            <asp:ListItem Value="YES">YES</asp:ListItem>
                            <asp:ListItem Value="NO" Selected="True">NO</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div>
                        <label style="font-size: 0.875rem; font-weight: 600; color: #1A1A2E;">Save Locker:</label>
                        <asp:DropDownList ID="ddlSaveLocker" runat="server" CssClass="form-control">
                            <asp:ListItem Value="YES">YES</asp:ListItem>
                            <asp:ListItem Value="NO" Selected="True">NO</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                ...
                <div style="margin-top: 1rem; display: flex; justify-content: flex-end;">
                     <asp:Button ID="btnPayByCard" runat="server" Text="Pay By Credit Card" CssClass="btn btn-secondary btn-sm" />
                </div>
            </div>
